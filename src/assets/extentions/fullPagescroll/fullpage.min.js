...
! function (n, t) {
    ...
    function It(n, t, e) {
        ...
        c.nn = (o = c.prevSlideIndex, i = c.slideIndex, o == i ? "none" : o > i ? "left" : "right"), c.direction = c.direction ? c.direction : c.nn, c.localIsResizing || un({
            P: !1
        }), Qn().onSlideLeave && !c.localIsResizing && "none" !== c.nn && _(Qn().onSlideLeave) && !1 === bt("onSlideLeave", c) ? un({
            A: !1
        }) : (O(t, wn), D(B(t), wn), _t(), c.localIsResizing || (Tt(c.prevSlide), Mt(t)), function (n) {
            ...
            if (o = t.slidesNav, i = t.slideIndex, Qn().slidesNavigation && null != o && (D(h(bn, o), wn), O(h("a", h("li", o)[i]), wn)), un({
    ...
    function Wt(n) {
        n.localIsResizing || (_(Qn().afterSlideLoad) && bt("afterSlideLoad", n), un({
            P: !0
        }), yt(n.destiny)), un({
            A: !1
        })
    ...
    var fe, se = {
        ...
        ln: (fe = 0, function (n) {
            ...
            fe = t, _(Qn().onScrollOverflow) && bt("onScrollOverflow", {
                position: t,
                direction: e
            }), g(n.target, Cn) && an.P && se.bn(e, n.target) && se.yn() && rn.l("onScrollOverflowScrolled", {
                direction: e
            })
        })
    };
    ...
    function ge(n) {
        var t = n.item,
            e = n.on.length,
            o = n.index();
        !cn().g && n.isVisible && (O(t, wn), _t()), pe = cn().g.item, Qn().paddingTop && b(t, {
    ...
    function Ee() {
        var n = Qn().css3 ? N(Qn()) + m() : nn(cn().p).item.offsetTop + nn(cn().p).item.offsetHeight,
            t = ut(n);
        l.test.top = -n + "px", b(r.body, {
            "scroll-snap-type": "none"
        }), b(At, {
            "scroll-behavior": "unset"
        }), un({
        ...
        if (null != o) {
            ...
            if (!(cn().g.item == o && !an.O || Qn().scrollBar && N(Qn()) === u.dtop && !g(o, xn))) {
                ...
                Qn().autoScrolling && Qn().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function (n) {
                        ...
                        var t = cn().g.item;
                        return n.isMovementUp ? z(t, J(t, Tn)) : C(t, Z(t, Tn).reverse()), ht(cn().g.item.offsetTop),
                            function () {
                                for (var n = h(Dn), t = 0; t < n.length; t++) Vt(n[t], "internal")
                            }(), n.An = t, n.dtop = n.element.offsetTop, n.yMovement = ft(cn().g, n.element), n
                    }(u)), u.localIsResizing || Tt(cn().g.item), O(o, wn), D(B(o), wn), _t(), Mt(o), un({
                        P: l.test.On
                    }), jt(r, i, u.anchorLink),
                    function (n) {
                        ...
                        }), Qn().scrollingSpeed)) : Ue(n);
                        else {
                            var o = ut(n.dtop);
                            l.test.top = -n.dtop + "px", b(At, {
                                "scroll-behavior": "unset"
                            }), clearTimeout(Fe), gt(o.element, o.options, Qn().scrollingSpeed, (function () {
    ...
    function Ue(n) {
        Qn().fitToSection && g(h(".fp-section.active")[0], xn) && b(r.body, {
            ...
            }(n), _(Qn().afterLoad) && !n.localIsResizing && bt("afterLoad", n), _t(), n.localIsResizing || yt(n.element), O(n.element, yn), D(B(n.element), yn), Ie(), se.cn(), un({
                P: !0
    ...
    function io(n) {
        ...
        if (ro(n)) {
            ...
            var r = Math.abs(Je - no) > i.innerHeight / 100 * Qn().touchSensitivity,
                ...
                c = Je > no ? "down" : "up";
            un({
                C: u ? Ze > to ? "right" : "left" : c
            }), u ? !an.A && a && (Ze > to ? Ft().m.right && rn.l("moveSlideRight", {
                section: t
    ...
    function jo(n) {
        var t = (new Date).getTime(),
            ...
            o = function (n, t) {
                (new Date).getTime();
                var e = cn().T && n.getBoundingClientRect().bottom >= 0 && "up" === je.xn(),
                    o = cn().kn;
                if (o) return I(t), !1;
                if (cn().T) {
                    if (e) {
                        var i;
                        if (!(o || Be("isNewKeyframe", "beyondFullpage") && je.Mn())) return (i = ut(nn(cn().p).item.offsetTop + nn(cn().p).item.offsetHeight)).element.scrollTo(0, i.options), un({
                            kn: !1
                        }), I(t), !1;
                        if (je.Mn()) return e = !1, un({
                            kn: !0
                        }), un({
                            S: "wheel"
                        }), Re(), I(t), !1
        ...
        if (Qn().autoScrolling && !Qe && !e) {
            ...
            var f = t - Ao;
            return Ao = t, f > 200 && (Oo = []), un({
                F: l
            }), an.P && tn(Oo, 10) >= tn(Oo, 70) && c && (un({
                S: "wheel"
            }), Ye(a < 0 ? "down" : "up")), !1
        }
        Qn().fitToSection && un({
    ...
    function Ro(n) {
        n ? (Do(!0), function () {
            if (oo.Dn && (a || c)) {
                Qn().autoScrolling && (xt.removeEventListener(oo.Dn, lo, {
                    passive: !1
                }), xt.addEventListener(oo.Dn, lo, {
                    passive: !1
                }));
                var n = Qn().touchWrapper;
                n.removeEventListener(oo.jn, ao), n.removeEventListener(oo.Dn, io, {
                    passive: !1
                }), n.addEventListener(oo.jn, ao), n.addEventListener(oo.Dn, io, {
                    passive: !1
                })
            }
        }()) : (Do(!1), function () {
            if (oo.Dn && (a || c)) {
                Qn().autoScrolling && (xt.removeEventListener(oo.Dn, io, {
                    passive: !1
                }), xt.removeEventListener(oo.Dn, lo, {
                    passive: !1
                }));
                var n = Qn().touchWrapper;
                n.removeEventListener(oo.jn, ao), n.removeEventListener(oo.Dn, io, {
    ...
    function Ko() {
        Vo || (Qn().autoScrolling && !Qn().scrollBar || !Qn().fitToSection) && qo(m()),
            function () {
                if (a)
                    for (var n = 0; n < 4; n++) Io = setTimeout((function () {
                ...
                ! function () {
                    if (un({
                            O: !0
                        }), qo(""), !Qn().fitToSection || Qn().autoScrolling || an.T || function () {
    ...
    function _o(n) {
        if (!g(Yn(), gn)) {
            ...
            an.T || a && No(a + 1), un({
                O: !1
            }), _(Qn().afterResize) && n && Qn().afterResize.call(Yn(), i.innerWidth, i.innerHeight), _(Qn().afterReBuild) && !n && Qn().afterReBuild.call(Yn()), q(Yn(), "afterRebuild")
        }
    }
    ...
    function ti(n) {
        ...
        if (!an.O && cn().g && (nn(cn().p), !cn().T && !cn().kn && (!Qn().autoScrolling || Qn().scrollBar))) {
            ...
            if (o = c, i = cn().g.item.offsetTop, a = i + m(), ("up" == o ? a >= N(Qn()) + m() : i <= N(Qn())) && (g(cn().g.item, yn) || (O(cn().g.item, yn), D(B(cn().g.item), yn))), e = (t = v[l]).item, !t.isActive) {
                ...
                x && (p = x.anchor, h = x.index()), an.P && (O(e, wn), D(B(e), wn), _(Qn().beforeLeave) && We("beforeLeave", k), _(Qn().onLeave) && bt("onLeave", k), _(Qn().afterLoad) && bt("afterLoad", k), Tt(w), Mt(e), yt(e), He(T, M - 1), Qn().anchors.length && un({
                    j: T
                }), jt(h, p, T), _t()), Qn().fitToSection && an.P && (clearTimeout(Zo), Zo = setTimeout((function () {
                    un({
                        D: !1
    ...
    return rn.u("onDestroy", (function () {
        ...
        function () {
            ...
            ee(!1, "internal"), ai(!0), Ro(!1), ei(!1), O(Yn(), gn), rn.l("onDestroy"), n && (ht(0), h("img[data-src], source[data-src], audio[data-src], iframe[data-src]", Yn()).forEach((function (n) {
                ...
                overflow: "",
                height: ""
            }), D(kt, mn), D(xt, hn), xt.className.split(/\s+/).forEach((function (n) {
            ...
            n && t ? n.fn.fullpage = function (e) {
                e = n.extend({}, e, {
                    $: n
                }), new t(this[0], e), Object.keys(l).forEach((function (n) {
